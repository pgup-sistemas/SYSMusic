...
const CursosPage: React.FC = () => {
    ...
    const filteredCourses = useMemo(() => {
        ...
        return courses.filter(course => {
            const teacherMatch = teacherFilter === 'all' || course.teacherId === parseInt(teacherFilter);
            const searchTermMatch = normalizeText(course.name).includes(normalizedSearch) ||
                                  normalizeText(course.instrument).includes(normalizedSearch);
            return teacherMatch && searchTermMatch;
        });
